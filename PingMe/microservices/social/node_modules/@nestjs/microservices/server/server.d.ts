...
import { ClientOptions, MessageHandler, MicroserviceOptions, MsPattern, ReadPacket, WritePacket } from '@nestjs/microservices/interfaces';
import { ConsumerDeserializer } from '@nestjs/microservices/interfaces/deserializer.interface';
import { ConsumerSerializer } from '@nestjs/microservices/interfaces/serializer.interface';
/**
 * @publicApi
 */
