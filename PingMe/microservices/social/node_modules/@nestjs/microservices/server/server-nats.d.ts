...
import { NatsEvents, NatsStatus } from '@nestjs/microservices/events/nats.events';
import { NatsOptions, TransportId } from '@nestjs/microservices/interfaces/microservice-configuration.interface';
...
export declare class ServerNats<E extends NatsEvents = NatsEvents, S extends NatsStatus = NatsStatus> extends Server<E, S> {
    ...
    protected statusEventEmitter: EventEmitter<{
        ...
        update: [data?: string | number | import("@nestjs/microservices/events/nats.events").ServersChangedEvent | undefined];
    }>;
