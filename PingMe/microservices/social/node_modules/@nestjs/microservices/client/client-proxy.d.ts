...
import { ClientOptions, MsPattern, PacketId, ReadPacket, WritePacket } from '@nestjs/microservices/interfaces';
import { ProducerDeserializer } from '@nestjs/microservices/interfaces/deserializer.interface';
import { ProducerSerializer } from '@nestjs/microservices/interfaces/serializer.interface';
/**
 * @publicApi
 */
